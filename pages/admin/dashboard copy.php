        ...
        <tr class="hover:bg-gray-50">
          ...
          <td class="p-4">
            <div class="flex items-center space-x-2">
              <button onclick="window.location.href='edit-user?uid=<?= urlencode($uid) ?>'" title="Edit">
                <!-- Edit SVG icon -->
              </button>
              <button class="modal-show" data-user-id="<?= $uid ?>" title="Delete">
                <!-- Delete SVG icon -->
              </button>
              <button onclick="window.location.href='admin/comments?uid=<?= urlencode($uid) ?>'"
                class="inline-block px-3 py-1.5 text-sm font-medium bg-blue-100 text-blue-700 hover:bg-blue-200 rounded transition">
                View Comments
            </button>
