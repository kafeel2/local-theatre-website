...
$comments->bind_result($commentId, $comment, $created, $commentStatus, $username, $blogName, $blogImg); // Bind the results to variables
?>
                ...
                <blockquote class="rounded-lg bg-gray-50 p-6 shadow-xs sm:p-8">
                    ...
                    <div>
                        <span class="inline-flex -space-x-px overflow-hidden rounded-md border bg-white shadow-xs">
                            ...
                            <button  onclick="window.location.href='approveController?cid=<?= urlencode($commentId) ?>'" 
                            ...
                            <button onclick="window.location.href='rejectController?cid=<?= urlencode($commentId) ?>'"
                                class="inline-block px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:relative">
                                Reject
                            </button>
                            <?php endif ?>
