      ...
      <div class="mx-4 mb-4 -mt-20">
        <form class="max-w-4xl mx-auto bg-white shadow-[0_2px_13px_-6px_rgba(0,0,0,0.4)] sm:p-8 p-4 rounded-md" action="registerController" method="post">
          <div class="grid sm:grid-cols-2 gap-6">
            <button type="button"
              class="w-full px-4 py-2.5 flex items-center justify-center rounded-md text-gray-800 text-sm tracking-wider border-none outline-none bg-gray-100 hover:bg-gray-200">
          ...
          <div class="grid sm:grid-cols-2 gap-6">
            <div>
              ...
              <input name="username" type="text" class="bg-gray-100 focus:bg-transparent w-full text-sm text-gray-800 px-4 py-2.5 rounded border focus:border-blue-600 outline-none transition-all" placeholder="Enter name" />
            </div>
            <div>
          ...
          <div class="mt-8">
            <button type="submit" class="py-2.5 px-4 text-sm tracking-wider rounded text-white bg-blue-500 hover:bg-blue-600 focus:outline-none">
              Sign up
            </button>
          </div>
        </form>
